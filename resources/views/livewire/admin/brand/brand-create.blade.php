    ...
    <div class="p-4 sm:ml-64">
        <div class="w-full mb-5 max-w-lg mx-auto mt-20 float-center bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700">
            <div class="py-8 px-4 mx-auto max-w-2xl lg:py-5">
                <p class="mb-4 text-2xl font-bold text-gray-900 dark:text-white">Add a new Brand</p>
                <form wire:submit.prevent='create'>
                    <div class="mb-3">
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="small_size">
                            Logo <div class="text-green-500 float-end" wire:loading wire:target="logo">Uploading...
                            </div>
                        </label>
                        <input 
                            wire:model="logo" 
                        ...
                        <p class="py-1 text-sm text-gray-500 dark:text-gray-300" id="file_input_help">JPEG, PNG or JPG
                        </p>
                        @if ($logo)
                    ...
                    <div class="mb-3">
                        ...
                        <a wire:navigate href="{{ route('brand.index') }}" 
                            type="button"
