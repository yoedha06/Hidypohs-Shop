    ...
    <div class="p-4 sm:ml-64">
        ...
        <div
            ...
            <div class="py-8 px-4 mx-auto max-w-2xl lg:py-5">
                <p class="mb-4 text-2xl font-bold text-gray-900 dark:text-white">Add a new Product</p>
                <form wire:submit.prevent='create'>
                    <div class="mb-3">
                        ...
                        <p class="py-1 text-sm text-gray-500 dark:text-gray-300" id="file_input_help">JPEG, PNG or JPG</p>
                        @if ($image)
                            <img 
                                class="mb-3 h-auto max-w-full rounded-lg" 
                    ...
                    <div class="mb-3">
                        <label for="small-input"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Price <span
                                class="text-red-600">*</span></label>
                        <input wire:model="price" type="number" id="small-input"
                            class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        @error('price')
                            <div class="text-red-500">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        <label for="small-input"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Order Date <span
                                class="text-red-600">*</span></label>
