...
class Index extends Component
{
    ...
    public $name ,$address, $phone, $image, $currentPassword, $newPassword, $gateway, $apiToken;
    ...
    public function update()
    {
        ...
        $this->redirect('/profile/admin', navigate:true);
    }
    ...
    private function verificationOtp()
    {
        ...
        try{
            ...
            if($send->successful()){
                ...
                $this->redirectRoute('otp.profile.admin', navigate:true);
